...
public class SortCounter
{
	...
	public static void main(String [] args) throws IOException
	{
		...
		do {
			...
			// print results
			printResults("Bubble Sort", sort.getCompareCount());    
			...
			// use a bubble sort
			sort.bubbleSort2(dataArray);

			// print results
			printResults("Bubble Sort2", sort.getCompareCount());
			...
			// use a quick sort
			sort.quickSort2(dataArray, 0, dataArray.length - 1);

			// print results
			printResults("Quick Sort2", sort.getCompareCount());			
...
//			System.out.println("Muemory Use = " + sort.getMemoryCount());
			...
			// use a merge sort
			sort.mergeSort2(dataArray, 0, dataArray.length - 1);

			// print results
			printResults("Merge Sort2", sort.getCompareCount());
			System.out.println("Max Memory Use = " + sort.getMaxMemoryCount2());
